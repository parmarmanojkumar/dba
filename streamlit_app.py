...
col1.metric("Compliance Score", f"{compliance_score}%", "+19%", help="Shows current compliance score based on queries and policy violations and provides % chnage from last month")
col4.metric("Total Agents", total_agents, "+200%")
col2.metric("Total Queries", f"{total_queries / 1000:.2f}K", "+53.1%", help="Shows Total no. of queries and provides % chnage from last month")
col3.metric("Queries Flagged", f"{queries_flagged}%", "-59%",help="Shows % of total queries flagged and provides % chnage from last month")
...
col4.metric("No. of Agent Framework", total_agents_fw)
col5.metric("Most Used Agent Framework", most_used_fw,)
col1.metric("Risky Agent", "Sales")
col2.metric("Most violated Policy", "PII")
col3.metric("OWASP TOP10", "SID")
